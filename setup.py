# Generated by Medikit 0.6.3 on 2018-08-08.
...
setup(
    ...
    install_requires=[
        'CacheControl (~= 0.12)', 'PyJWT (~= 1.5)', 'django (~= 2.0)',
        'jinja2 (~= 2.10)', 'requests (~= 2.18)'
    ],
    extras_require={
    ...
    download_url=
    'https://github.com/hartym/django-includes/archive/{version}.tar.gz'.
